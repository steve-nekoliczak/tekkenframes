...
config :tekkenframes, TekkenframesWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "yXFBHQToPuJmV90RaAvLXOH9xDGa8KuL2omJxSL/PfQTSSo7FlIsaosnQBxA4bbg",
  watchers: [
...
config :tekkenframes, TekkenframesWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tekkenframes_web/(live|views)/.*(ex)$",
      ~r"lib/tekkenframes_web/templates/.*(eex)$"
    ]
  ]
